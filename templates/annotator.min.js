    ...
    Annotator = (function (_super) {
        ...
        Annotator.prototype._setupViewer = function () {
            ...
            this.viewer
                ...
                .bind({ mouseover: this.clearViewerHideTimer, mouseout: this.startViewerHideTimer });
            return this;
        };
            ...
            onMousemove = function (event) {
                ...
                if (mousedown && throttle === false) {
                    ...
                    if (mousedown.element === resize[0]) {
                        ...
                        editor.css({ top: parseInt(editor.css("top"), 10) + diff.top, left: parseInt(editor.css("left"), 10) + diff.left });
                        mousedown.top = event.pageY;
                        mousedown.left = event.pageX;
                    }
                    throttle = true;
